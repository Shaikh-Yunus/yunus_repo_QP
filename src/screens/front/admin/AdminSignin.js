...
const AdminSignin=(props)=>{
    ...
    const gotoAdminDashboard = ()=>{
        navigation.navigate('/admin-stack-navigation')
    }
    const gotoForgotPass = () =>{
        navigation.navigate('/forgot-password-admin')
    }
    return (
        <View style={styles.background}>
            ...
            <View style={styles.container}>
                ...
                <Pressable style={[globatStyles.button, {width: '92%', marginTop: 0,}]} onPress={gotoAdminDashboard}><Text style={globatStyles.btnText}>Sign In</Text></Pressable>
            </View>
        </View>
    )
}
