    ...
    return (
        <View style={styles.background}>
            ...
            <View style={styles.container}>
                ...
                <Pressable style={[globatStyles.button, {width: '92%'}]} onPress={generateOtp}><Text style={globatStyles.btnText}>Generate OTP</Text></Pressable>
            </View>
        </View>
    )
}
