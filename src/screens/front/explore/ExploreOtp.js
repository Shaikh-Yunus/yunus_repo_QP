...
const ExploreOtp=()=>{
    ...
    const signupDetails = ()=>{
        ...
        navation.navigate('/signup-details')
            ...
            <View style={globatStyles.overlay}></View>
                <View style={styles.container}>
                    ...
                    <View style={styles.business}>
                        <Text style={styles.businessText}>Explore</Text>
                        <Image source={Images.explorerIcon} />
                    </View>
                    ...
                    <Pressable style={[globatStyles.button, {width: '88%'}]} onPress={signupDetails}><Text style={globatStyles.btnText}>Enter OTP</Text></Pressable>
                </View>
        </View>
    )
}
