            ...
            {loader ?
                ...
                : <ScrollView style={styles.container}>
                    <Text style={styles.infoText}>
                        Add and manage users, granting them easy access to your business.
                    </Text>
                    {users.length > 0 ?
                        <>
                    ...
                    }
                    {
                        !addUser ? <Pressable style={[styles.addUserBtn, { width: '100%' }]} onPress={() => setAddUser(true)}><Text style={styles.btnText}>Add User</Text></Pressable> : (
                            <View style={{ marginTop: Constants.margin, }}>
                                ...
                                <TextInput style={globatStyles.inputText} maxLength={10} placeholder='Phone number' onChangeText={setPhone} />
                                <SelectDropdown
                                    data={privilages}
