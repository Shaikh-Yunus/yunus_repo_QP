...
const AddModerator = (props) => {
    ...
    return (
        <View style={globatStyles.wrapper}>
            ...
            <CustomAppBar navigation={navigation} isMainscreen={false} isReel={false} headerRight={false} title='Add Moderator' />
            <ScrollView style={styles.container}>
                <Text style={{fontFamily: Constants.fontFamily,}}>can View/Create/Update.</Text>
